...
class IscsiTargetTest(ModuleTestCase):
    ...
    def test_get_enable_interface_settings_enabled_pass(self):
        ...
        update, body = mgmt_interface.get_enable_interface_settings(iface, False, {})
        self.assertTrue(update and body["ipv4Enabled"])
    ...
    def test_get_enable_interface_settings_disabled_pass(self):
        ...
        update, body = mgmt_interface.get_enable_interface_settings(iface, False, {})
        self.assertTrue(update and not body["ipv4Enabled"])
