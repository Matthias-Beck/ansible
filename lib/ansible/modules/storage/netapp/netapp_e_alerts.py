...
short_description: manage E-Series email notification settings
description:
...
options:
    ...
    test:
        description:
            ...
            - Only applicable if I(state=enabled/present).
        default: no
        type: bool
    log_path:
        description:
...
class Alerts(object):
    def __init__(self):
        ...
        required_if = [
            ['state', 'present', ['server', 'sender', 'recipients']],
        ...
        self.alerts = args['state'] in ['enabled', 'present']
